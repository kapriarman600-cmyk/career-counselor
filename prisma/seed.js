...
async function main() {
  ...
  // ─────────────────────────────────────────────
  // 1. Seed Exams (upsert — safe to re-run)
  // ─────────────────────────────────────────────
  ...
  // ─────────────────────────────────────────────
  // 2. Seed Careers (upsert — safe to re-run)
  // ─────────────────────────────────────────────
  console.log("Seeding Careers...");
  const careersData = [
    { id: "engineering", title: "Engineering", industry: "Technology & Infrastructure", description: "Designing, building, and maintaining engines, machines, structures, software, and systems.", demandLevel: "High", averageSalary: "₹4 LPA - ₹30 LPA", futureScope: "Continuous expansion due to rapid digitization, smart city developments, automation, and green energy transformations.", requiredSkills: "Problem Solving, Analytical Thinking, Mathematics, Programming, Project Management, Teamwork.", overview: "Engineering spans multiple domains like Computer Science, Mechanical, Civil, Electrical, Aerospace, and Biotechnology. It is the application of scientific principles to build real-world systems.", eligibility: "10+2 with Physics, Chemistry, and Mathematics. Clear engineering entrance examinations.", topColleges: "IIT Bombay, IIT Delhi, BITS Pilani, NIT Trichy, VIT Vellore.", entranceExams: "JEE Main, JEE Advanced, BITSAT, VITEEE, MHTCET.", roadmap: "1. Complete 10+2. 2. Excel in JEE/BITSAT. 3. Earn a B.Tech/B.E. degree. 4. Build projects and do summer internships. 5. Secure placement or pursue M.Tech/MS.", recommendedResources: "Coursera, edX, NPTEL Lectures, standard university textbooks." },
    { id: "medical", title: "Medical Practitioner", industry: "Healthcare", description: "Diagnosing, treating, and managing patient health, performing surgeries, and working in medical research.", demandLevel: "High", averageSalary: "₹6 LPA - ₹50 LPA", futureScope: "Critical demand globally. The rise of telemedicine, robotic surgeries, and personalized gene therapies is reshaping healthcare.", requiredSkills: "Empathy, Clinical Knowledge, Resiliency, Attention to Detail, Decision Making.", overview: "Practicing medicine involves extensive study and training to become an MBBS doctor, dentist, surgeon, or clinical specialist dedicated to patient well-being.", eligibility: "10+2 with Physics, Chemistry, and Biology. Secure a high score in NEET-UG.", topColleges: "AIIMS New Delhi, JIPMER Puducherry, Maulana Azad Medical College, KGMU Lucknow.", entranceExams: "NEET UG, NEET PG (for specialization).", roadmap: "1. Pass Class 12 with PCB. 2. Clear NEET-UG. 3. Complete MBBS (4.5 years + 1 year internship). 4. Clear NEET-PG. 5. Earn MD/MS specialization.", recommendedResources: "Marrow, Prepladder, Robbins Pathology, Gray's Anatomy." },
    { id: "law", title: "Law & Legal Services", industry: "Legal", description: "Representing clients in courts, advising on legal matters, drafting contracts, and working in corporate compliance.", demandLevel: "Medium", averageSalary: "₹5 LPA - ₹40 LPA", futureScope: "Growth in corporate law, IP law, cyber security law, and environmental law fields.", requiredSkills: "Critical Reasoning, Public Speaking, Analytical Writing, Research, Negotiation.", overview: "Legal professionals advocate for clients, interpret statutes, draft agreements, and mediate disputes in courts or corporate settings.", eligibility: "Class 12 pass for 5-year integrated BA LLB, or Graduation for 3-year LLB. Clear CLAT/LSAT.", topColleges: "NLSIU Bangalore, NALSAR Hyderabad, NUJS Kolkata, Faculty of Law (Delhi University).", entranceExams: "CLAT, AILET, LSAT India, DU LLB.", roadmap: "1. Excel in CLAT. 2. Pursue 5-year integrated LLB. 3. Participate in moot courts and intern under advocates. 4. Pass the All India Bar Exam (AIBE). 5. Join a corporate firm or start litigating.", recommendedResources: "LiveLaw, Bar and Bench, Constitution of India bare act." },
    { id: "management", title: "Management Consultant / Manager", industry: "Corporate Business", description: "Structuring business operations, strategizing corporate growth, managing human resources, and advising executives.", demandLevel: "High", averageSalary: "₹8 LPA - ₹50 LPA", futureScope: "Sustained high demand for agile managers, strategy consultants, and product leaders in global firms.", requiredSkills: "Leadership, Strategic Planning, Business Communication, Financial Analysis, Problem Solving.", overview: "Managers organize teams and resources to optimize productivity, increase revenue, and navigate complex commercial environments.", eligibility: "Bachelor's degree in any field. MBA from a reputable business school is highly recommended.", topColleges: "IIM Ahmedabad, IIM Bangalore, IIM Calcutta, ISB Hyderabad, XLRI Jamshedpur.", entranceExams: "CAT, GMAT, XAT, SNAP.", roadmap: "1. Earn any undergraduate degree. 2. Gain 1-3 years of work experience (optional but helpful). 3. Score high in CAT/GMAT. 4. Complete MBA/PGDM. 5. Join strategy firms or corporate leadership tracks.", recommendedResources: "Harvard Business Review, McKinsey Insights, Wall Street Journal." },
    { id: "design", title: "Design (UI/UX, Product, Fashion)", industry: "Creative Industries", description: "Designing user interfaces, consumer products, apparel, and communication assets.", demandLevel: "High", averageSalary: "₹4 LPA - ₹25 LPA", futureScope: "UI/UX design is expanding exponentially due to app developments. Product designers are key for tech and physical items.", requiredSkills: "Creativity, Visual Empathy, Wireframing, Adobe Suite, Figma, Prototyping.", overview: "Designing is a user-centric discipline combining aesthetics, psychology, and functionality to improve product interactions.", eligibility: "Class 12 in any stream. Clear entrance exams like UCEED, NID, NIFT.", topColleges: "NID Ahmedabad, IDC School of Design (IIT Bombay), NIFT Delhi, Srishti Institute.", entranceExams: "UCEED, CEED, NID DAT, NIFT Entrance.", roadmap: "1. Complete 10+2. 2. Clear UCEED/NID exam. 3. Complete B.Des/M.Des. 4. Build a strong design portfolio on Behance/Dribbble. 5. Intern and join design agencies or product companies.", recommendedResources: "Figma tutorials, NN Group UX articles, Interaction Design Foundation." },
    { id: "government-jobs", title: "Government Jobs (Civil Administration)", industry: "Public Service", description: "Administrative governance, policy implementation, law enforcement, and municipal administration.", demandLevel: "High", averageSalary: "₹6 LPA - ₹20 LPA", futureScope: "High security, social prestige, and direct public impact. Moving towards digital e-governance systems.", requiredSkills: "Public Administration, Ethics, Policy Formulation, Leadership, Crisis Management.", overview: "Administrative officers represent the executive arm of state and central governments, managing public offices, security, and welfare policies.", eligibility: "Graduation in any stream. Clear state or central civil services tests.", topColleges: "LBSNAA Mussoorie (for training), public universities for degree.", entranceExams: "UPSC CSE, State PSC (UPPCS, BPSC, etc.).", roadmap: "1. Complete Graduation. 2. Prepare comprehensively for Civil Services. 3. Pass Prelims, Mains, and Interview. 4. Complete foundation training. 5. Take charge as Assistant Commissioner/SDM.", recommendedResources: "Yojana Magazine, Kurukshetra Magazine, PRS India." },
    { id: "banking", title: "Banking & Financial Services", industry: "Finance", description: "Retail banking, loan management, investment advisory, risk assessment, and financial auditing.", demandLevel: "Medium", averageSalary: "₹4 LPA - ₹22 LPA", futureScope: "Strong growth driven by fintech integrations, digital payment systems, and micro-financing.", requiredSkills: "Numerical Ability, Accounting, Customer Relations, Risk Management.", overview: "Bankers manage monetary deposits, evaluate creditworthiness, offer investment products, and manage compliance guidelines.", eligibility: "Graduation. Cleared IBPS/SBI bank exams.", topColleges: "National Institute of Bank Management, Delhi University, NMIMS.", entranceExams: "IBPS PO, SBI PO, IBPS Clerk.", roadmap: "1. Obtain a graduate degree. 2. Prepare for bank entrance exams. 3. Clear Prelims and Mains. 4. Complete training program. 5. Get posted as Assistant Manager.", recommendedResources: "Economic Times, CAclubindia, RBI bulletins." },
    { id: "defence", title: "Defence Services (Armed Forces)", industry: "Military", description: "Defending national borders, tactical combat operations, intelligence gathering, and disaster relief.", demandLevel: "High", averageSalary: "₹8 LPA - ₹25 LPA", futureScope: "Technological modernization of military forces (cyber warfare, drone systems) creates high-end tech-defence openings.", requiredSkills: "Patriotism, Leadership, Physical Fitness, Mental Toughness, Team Coordination.", overview: "Serving in the Indian Army, Navy, or Air Force offers a life of discipline, adventure, high honor, and leadership.", eligibility: "12th standard (for NDA) or Graduation (for CDS/AFCAT). Must qualify physical and medical fitness test.", topColleges: "NDA Khadakwasla, IMA Dehradun, INA Ezhimala, AFA Dundigal.", entranceExams: "NDA, CDS, AFCAT, INET.", roadmap: "1. Apply during 12th or graduation. 2. Clear written exams (NDA/CDS). 3. Pass 5-day SSB interview. 4. Pass medical exams. 5. Undergo training at academy.", recommendedResources: "SSBCrack, joinindiannavy.gov.in." },
    { id: "data-science", title: "Data Scientist", industry: "Technology", description: "Extracting actionable insights from structured/unstructured data using statistical modeling and programming.", demandLevel: "High", averageSalary: "₹6 LPA - ₹35 LPA", futureScope: "Extremely high. Data-driven decision making is now the standard across all industries (retail, healthcare, finance).", requiredSkills: "Python, SQL, Statistics, Machine Learning, Data Visualization (Tableau/PowerBI).", overview: "Data scientists clean and analyze massive datasets, building predictive models to forecast trends and optimize performance.", eligibility: "Graduation in Computer Science, Statistics, Mathematics, or related field.", topColleges: "IIT Madras (BSc Data Science), ISI Kolkata, IIIT Bangalore.", entranceExams: "GATE, JEE, or direct university selection.", roadmap: "1. Learn Python and SQL. 2. Master Probability and Statistics. 3. Build data analysis projects. 4. Learn machine learning algorithms. 5. Apply for junior analyst or scientist roles.", recommendedResources: "Kaggle, Towards Data Science, Fast.ai." },
    { id: "ai-ml", title: "AI/ML Engineer", industry: "Artificial Intelligence", description: "Designing, training, and deploying neural networks and machine learning models for natural language, vision, and recommendation.", demandLevel: "High", averageSalary: "₹8 LPA - ₹45 LPA", futureScope: "Explosive growth due to LLMs, generative AI, autonomous systems, and advanced robotics.", requiredSkills: "Deep Learning, PyTorch/TensorFlow, Linear Algebra, Python, Model Deployment (MLOps).", overview: "AI/ML Engineers build systems that learn from data to make decisions, translate speech, recognize images, and generate text.", eligibility: "B.Tech/M.Tech in CSE/IT or Mathematics, or strong self-taught machine learning portfolio.", topColleges: "IIT Hyderabad, IIIT Hyderabad, IIT Delhi.", entranceExams: "JEE Advanced, GATE.", roadmap: "1. Learn core software engineering. 2. Dive into Calculus, Linear Algebra, and Statistics. 3. Master PyTorch and TensorFlow. 4. Implement paper research models. 5. Deploy models on cloud (AWS/GCP).", recommendedResources: "Deeplearning.ai, Stanford CS231n / CS224n courses." },
    { id: "cyber-security", title: "Cyber Security Analyst / Engineer", industry: "Information Security", description: "Protecting organization networks, databases, and application systems from cyber threats, hacking, and leaks.", demandLevel: "High", averageSalary: "₹5 LPA - ₹30 LPA", futureScope: "Critical need as financial transactions, healthcare records, and cloud computing grow more vulnerable to cyber espionage.", requiredSkills: "Ethical Hacking, Network Security, Cryptography, Linux, Pen-Testing, Splunk.", overview: "Cybersecurity professionals prevent attacks, detect system breaches, perform vulnerability tests, and respond to security emergencies.", eligibility: "Bachelor's degree in CS/IT, or certifications like CEH, CISSP, CompTIA Security+.", topColleges: "National Forensic Sciences University (NFSU), IIIT Allahabad.", entranceExams: "GATE, JEE.", roadmap: "1. Learn Networking fundamentals (TCP/IP). 2. Learn Linux and bash scripting. 3. Practice on TryHackMe/HackTheBox. 4. Earn CEH/Security+ certification. 5. Seek SOC analyst positions.", recommendedResources: "PortSwigger Web Security Academy, TryHackMe." },
    { id: "software-development", title: "Software Engineer", industry: "Software Industry", description: "Writing clean, scalable code to build web, mobile, and system-level applications.", demandLevel: "High", averageSalary: "₹4 LPA - ₹40 LPA", futureScope: "Fundamental role driving global tech ecosystems. Continuous shift toward cloud, serverless, and mobile systems.", requiredSkills: "Data Structures & Algorithms, Java/C++/JS, System Design, Git, Database Management.", overview: "Software development is the architecture and creation of software systems that power businesses, mobile apps, websites, and infrastructure.", eligibility: "Graduate degree in engineering or computer applications, or coding bootcamp graduates.", topColleges: "IITs, NITs, IIITs, BITS Pilani, DTU.", entranceExams: "JEE Main, JEE Advanced, GATE, NIMCET.", roadmap: "1. Learn programming logic (Java/Python/C++). 2. Master Data Structures and Algorithms. 3. Build full-stack web/mobile projects. 4. Practice competitive coding on LeetCode. 5. Apply for internships/jobs.", recommendedResources: "LeetCode, FreeCodeCamp, GeeksforGeeks." },
    { id: "commerce", title: "Commerce & Trade Professional", industry: "Commerce", description: "Overseeing trade operations, supply chain flows, business accounting, and tax management.", demandLevel: "Medium", averageSalary: "₹3 LPA - ₹18 LPA", futureScope: "Solid growth supported by global e-commerce logistics and corporate supply chains.", requiredSkills: "Taxation, Commercial Law, Supply Chain Management, Auditing.", overview: "Commerce professionals manage retail structures, export-import legalities, bookkeeping, and trading systems.", eligibility: "B.Com/M.Com degree, or specialized logistics diplomas.", topColleges: "SRCC Delhi, LSR College, Loyola College Chennai.", entranceExams: "CUET, university direct admissions.", roadmap: "1. Complete B.Com. 2. Specialise in Supply Chain or taxation modules. 3. Learn ERP tools like SAP/Tally. 4. Work in logistics or audit firms.", recommendedResources: "Commerce Academy, ICAI updates." },
    { id: "finance", title: "Financial Analyst / Investment Banker", industry: "Financial Services", description: "Guiding investments, valuing companies, managing mergers and acquisitions (M&A), and capital restructuring.", demandLevel: "High", averageSalary: "₹8 LPA - ₹45 LPA", futureScope: "Growth driven by the rise of capital markets, retail investments, and venture capital flows in start-ups.", requiredSkills: "Financial Modeling, Valuation, Excel, Macroeconomics, Communication.", overview: "Finance professionals analyze corporate statements, manage risk portfolios, structure IPOs, and advise clients on capital allocation.", eligibility: "B.Com, BBA (Finance), CFA certification, or MBA (Finance) from top colleges.", topColleges: "IIMs, SRCC, NMIMS, JBIMS Mumbai.", entranceExams: "CAT, CFA program examinations.", roadmap: "1. Pursue B.Com/BBA. 2. Clear CFA Level 1. 3. Practice Excel modeling. 4. Secure corporate finance internship. 5. Clear CFA Level 2 & 3.", recommendedResources: "Investopedia, CFA Institute, Corporate Finance Institute." },
    { id: "ca", title: "Chartered Accountant (CA)", industry: "Accounting & Auditing", description: "Auditing company accounts, assessing tax returns, financial planning, and legal financial advisory.", demandLevel: "High", averageSalary: "₹7 LPA - ₹30 LPA", futureScope: "Guaranteed demand. CAs are mandatory for every registered business to file tax sheets and audit books.", requiredSkills: "Taxation, Auditing, Analytical Precision, Integrity, Indian Accounting Standards.", overview: "Chartered Accountants handle financial reports, tax regulations, auditing systems, and corporate accounting.", eligibility: "Registered with ICAI. Pass Foundation, Intermediate, and Final exams.", topColleges: "The Institute of Chartered Accountants of India (ICAI) is the licensing body.", entranceExams: "CA Foundation, CA Intermediate, CA Final.", roadmap: "1. Register with ICAI after 12th. 2. Clear CA Foundation. 3. Clear CA Intermediate. 4. Complete 3-year articleship training. 5. Clear CA Final to obtain license.", recommendedResources: "ICAI study material, CA club portals." },
    { id: "cs", title: "Company Secretary (CS)", industry: "Corporate Governance", description: "Managing corporate law compliance, filing regulatory reports, and advising directors on legal guidelines.", demandLevel: "Medium", averageSalary: "₹5 LPA - ₹20 LPA", futureScope: "Increasing demand due to stricter government mandates on corporate compliance and ESG requirements.", requiredSkills: "Company Law, Corporate Governance, Legal Drafting, Board Room Management.", overview: "A Company Secretary is the principal officer ensuring that corporate actions adhere to all statutory regulations.", eligibility: "Passed CS Foundation (now CSEET), Executive, and Professional examinations.", topColleges: "Institute of Company Secretaries of India (ICSI).", entranceExams: "CSEET, CS Executive, CS Professional.", roadmap: "1. Register for CSEET after 10+2. 2. Clear CS Executive. 3. Complete articleship training. 4. Clear CS Professional. 5. Gain ICSI membership.", recommendedResources: "ICSI Journals and manuals." },
    { id: "digital-marketing", title: "Digital Marketer / Growth Hacker", industry: "Marketing & Advertising", description: "Managing online advertisement campaigns, SEO optimization, social media marketing, and customer acquisition funnels.", demandLevel: "High", averageSalary: "₹3 LPA - ₹18 LPA", futureScope: "High growth as ad spends shift completely from print/TV to digital platforms (Google, Meta, TikTok).", requiredSkills: "SEO, Copywriting, Google Ads, Meta Pixel, Web Analytics (GA4), A/B Testing.", overview: "Digital marketers analyze user acquisition channels and write campaigns to grow product sales and brand visibility.", eligibility: "Degree in marketing/communications, or self-taught portfolio with verified campaign results.", topColleges: "MICA Ahmedabad, Delhi University, digital training institutes.", entranceExams: "CUET, CAT.", roadmap: "1. Learn copywriting and visual design. 2. Certify in Google Ads/SEO. 3. Build a personal brand or run small budgets. 4. Scale client campaigns. 5. Get hired in tech startups.", recommendedResources: "Backlinko, HubSpot Academy, Google Skillshop." },
    { id: "civil-services", title: "Civil Services Officer (IAS/IPS)", industry: "Public Administration", description: "Managing district administration, maintain law and order, and designing policy blueprints at state/national levels.", demandLevel: "High", averageSalary: "₹56,100 starting basic (with elite perks, housing, transport).", futureScope: "Highly prestigious. Core leadership roles inside the Indian administrative fabric.", requiredSkills: "Leadership, Public Policy, Analytical Reasoning, Crisis Response.", overview: "Civil servants manage government departments, supervise state welfare programs, and maintain municipal stability.", eligibility: "Any graduation degree. Age limit 21-32 years.", topColleges: "Lal Bahadur Shastri National Academy of Administration (LBSNAA).", entranceExams: "UPSC CSE.", roadmap: "1. Graduate. 2. Clear UPSC Prelims. 3. Excel in Mains descriptive. 4. Clear interview. 5. Undergo training and get posted as Sub-Divisional Magistrate.", recommendedResources: "Press Information Bureau, PRS India bulletins." },
    { id: "teaching", title: "Educator / School Teacher", industry: "Education", description: "Teaching elementary, secondary, or high-school students, designing curriculums, and mentoring.", demandLevel: "Medium", averageSalary: "₹3 LPA - ₹10 LPA", futureScope: "Steady demand. Expansion in digital/hybrid education models and international IB board curriculums in India.", requiredSkills: "Patience, Lesson Planning, Classroom Management, Child Psychology.", overview: "Educators cultivate academic skills, values, and knowledge in students inside school settings.", eligibility: "Graduation + B.Ed (Bachelor of Education). Cleared Teacher Eligibility Test (TET).", topColleges: "Delhi University (CIE), Banaras Hindu University.", entranceExams: "CTET, State TETs.", roadmap: "1. Complete Graduation. 2. Complete B.Ed program. 3. Clear CTET exam. 4. Apply to public or private schools.", recommendedResources: "NCERT books, CBSE circulars." },
    { id: "research", title: "Research Scientist / Academician", industry: "R&D / Academia", description: "Conducting scientific lab experiments, writing research papers, and lecturing at universities.", demandLevel: "Medium", averageSalary: "₹5 LPA - ₹25 LPA", futureScope: "Crucial for tech innovation, medicine discovery, space ventures, and sustainable energy development.", requiredSkills: "Scientific Inquiry, Lab Practice, Statistical Tools, Technical Writing.", overview: "Scientists discover new concepts, test hypotheses, and document breakthroughs to push the boundaries of knowledge.", eligibility: "Postgraduate degree followed by a Ph.D. Cleared CSIR NET / UGC NET.", topColleges: "IISc Bangalore, TIFR Mumbai, IITs, JNU.", entranceExams: "CSIR NET, UGC NET, JEST, GATE.", roadmap: "1. Complete a BSc/B.Tech. 2. Pursue MSc or M.Tech. 3. Clear CSIR-NET/UGC-NET. 4. Secure PhD admission. 5. Publish in peer-reviewed journals and join labs.", recommendedResources: "ResearchGate, Google Scholar, ScienceDirect." }
  ];
  ...
  // ─────────────────────────────────────────────
  // 3. Seed Colleges (upsert — safe to re-run)
  // ─────────────────────────────────────────────
  console.log("Seeding Colleges...");
  const collegesData = [
    { id: "iit-bombay", name: "Indian Institute of Technology, Bombay", location: "Powai, Mumbai, Maharashtra", type: "Public", ranking: 3, accreditation: "NIRF #3 Engineering, Grade A++ by NAAC", description: "One of the most prestigious public technical universities in Asia, IIT Bombay is widely known for its pioneering research in technology, design, science, and entrepreneurship.", avgPlacement: "₹22.5 LPA", highestPlacement: "₹3.67 Crore PA", officialWebsite: "www.iitb.ac.in", cutoffs: "JEE Advanced rank under 100 for CSE.", admissionProcess: "1. Appear in JEE Main. 2. Qualify for JEE Advanced. 3. Register and participate in JoSAA Counselling.", reviews: "Top-tier research labs, incredible alumni network (WhatsApp, Flipkart founders). Best entrepreneurship culture among IITs." },
    { id: "iit-delhi", name: "Indian Institute of Technology, Delhi", location: "Hauz Khas, New Delhi", type: "Public", ranking: 2, accreditation: "NIRF #2 Engineering, Grade A++ by NAAC", description: "IIT Delhi stands at the forefront of science and technology education in India, known for producing top global engineers, scientists, and entrepreneurs.", avgPlacement: "₹24.0 LPA", highestPlacement: "₹1.7 Crore PA", officialWebsite: "www.iitd.ac.in", cutoffs: "JEE Advanced rank under 80 for CSE.", admissionProcess: "Qualify JEE Advanced -> JoSAA Counselling.", reviews: "Best location — right in New Delhi with industry connections. Outstanding internship opportunities." },
    { id: "iit-madras", name: "Indian Institute of Technology, Madras", location: "Adyar, Chennai, Tamil Nadu", type: "Public", ranking: 1, accreditation: "NIRF #1 Engineering Institute, NAAC A++", description: "India's #1 ranked engineering institution for 9 consecutive years. Known for excellence in research, innovation, and producing world-class engineers.", avgPlacement: "₹25.0 LPA", highestPlacement: "₹2.08 Crore PA", officialWebsite: "www.iitm.ac.in", cutoffs: "JEE Advanced rank under 60 for CSE.", admissionProcess: "JEE Advanced + JoSAA Counselling.", reviews: "Beautiful lush green campus with deer roaming freely. Excellent NPTEL course initiatives. Strong research output." },
    { id: "iim-ahmedabad", name: "Indian Institute of Management, Ahmedabad", location: "Vastrapur, Ahmedabad, Gujarat", type: "Public", ranking: 1, accreditation: "NIRF #1 Management, NAAC A++ Grade", description: "The crown jewel of Indian management education. IIM Ahmedabad is consistently the #1 business school in India with exceptional placements.", avgPlacement: "₹35.0 LPA", highestPlacement: "₹1.62 Crore PA", officialWebsite: "www.iima.ac.in", cutoffs: "CAT 99.5+ percentile required. 100 percentile almost mandatory for unconventional profiles.", admissionProcess: "Clear CAT with 99.5+ -> IIMA PGPX/PGP WAT-PI rounds.", reviews: "Unmatched case-study teaching methodology. Incredible alumni power. Extremely rigorous program." },
    { id: "nlsiu-bangalore", name: "National Law School of India University", location: "Nagarbhavi, Bengaluru, Karnataka", type: "Public", ranking: 1, accreditation: "NIRF #1 Law School", description: "The premier law school in India, NLSIU is known for producing top advocates, corporate lawyers, judges, and legal academics.", avgPlacement: "₹22.0 LPA", highestPlacement: "₹45 LPA", officialWebsite: "www.nls.ac.in", cutoffs: "CLAT rank under 200 for General category.", admissionProcess: "Qualify CLAT exam -> CLAT Consortium Counselling.", reviews: "Extremely competitive peer group. Flagship 5-year BA LLB (Hons). Excellent moot court tradition." },
    { id: "nit-trichy", name: "National Institute of Technology, Tiruchirappalli", location: "Trichy, Tamil Nadu", type: "Public", ranking: 9, accreditation: "NIRF #9 Engineering, NBA Accredited", description: "Established in 1964, NIT Trichy is widely regarded as the top NIT in India, offering world-class infrastructure and top-tier placements.", avgPlacement: "₹12.5 LPA", highestPlacement: "₹52 LPA", officialWebsite: "www.nitt.edu", cutoffs: "JEE Main percentile 99.5+ for CSE, 98+ for core branches.", admissionProcess: "1. Appear for JEE Main. 2. Participate in CSAB/JoSAA counselling.", reviews: "Massive campus. Culturally diverse student crowd. Great computer center facility. Placement records rival the newer IITs." },
    { id: "iiit-hyderabad", name: "International Institute of Information Technology, Hyderabad", location: "Gachibowli, Hyderabad, Telangana", type: "Private-Public", ranking: 15, accreditation: "Grade A by NAAC", description: "Famous for its specialized research in Computer Science, AI, Robotics, and Software Engineering. It has a research-focused curriculum right from undergraduate years.", avgPlacement: "₹30.0 LPA (CSE)", highestPlacement: "₹1.02 Crore PA", officialWebsite: "www.iiit.ac.in", cutoffs: "JEE Main percentile 99.9+ for CSE, 99.7+ for ECE.", admissionProcess: "Admission through JEE Main score, DASA (for NRIs), or UGEE (Undergraduate Entrance Exam).", reviews: "Intense coding culture. Academic curriculum is demanding but rewarding. Placements are among the best in the nation." },
    { id: "aiims-delhi", name: "All India Institute of Medical Sciences", location: "Ansari Nagar, New Delhi", type: "Public", ranking: 1, accreditation: "NIRF #1 Medical", description: "The premier medical college and public hospital in India. Established in 1956, it is known for providing subsidised elite medical care and cutting-edge research.", avgPlacement: "Internships stipend of ₹30,000/month. Superb PG prospects.", highestPlacement: "Highly variable (Post-Graduate specialties earn upwards of 50 LPA).", officialWebsite: "www.aiims.edu", cutoffs: "NEET rank under top 50 (General Category).", admissionProcess: "Crack NEET-UG with 700+ score and apply through MCC counseling.", reviews: "World-class faculty. Unbelievable clinical exposure. Extremely affordable fees (under ₹6000 for MBBS complete course)." },
    { id: "jipmer-puducherry", name: "Jawaharlal Institute of Postgraduate Medical Education & Research", location: "Puducherry", type: "Public", ranking: 3, accreditation: "Institute of National Importance", description: "An institution of national importance under the Ministry of Health, offering top-tier medical training, nursing, and healthcare services.", avgPlacement: "Interns receive monthly stipends, 100% internship placement.", highestPlacement: "Excellent PG selection rate.", officialWebsite: "www.jipmer.edu.in", cutoffs: "NEET rank in top 200-300.", admissionProcess: "Direct NEET-UG ranking-based counselling.", reviews: "Beautiful campus in Puducherry. Great clinical teaching. Excellent library and sports facilities." },
    { id: "delhi-university", name: "University of Delhi", location: "New Delhi (North & South Campuses)", type: "Public", ranking: 11, accreditation: "NAAC A+ Grade", description: "One of the most famous central universities in India. Known for its prestigious colleges like SRCC, St. Stephen's, and Hindu College.", avgPlacement: "₹6 LPA - ₹15 LPA (varies by college)", highestPlacement: "₹36 LPA (SRCC)", officialWebsite: "www.du.ac.in", cutoffs: "CUET scores in top percentiles (99%+ for top courses at top colleges).", admissionProcess: "Appear for CUET-UG and register on the CSAS portal.", reviews: "Excellent crowd. Vibrant extracurricular activities. Great faculty, especially for economics, commerce, and humanities." },
    { id: "banaras-hindu-university", name: "Banaras Hindu University", location: "Varanasi, Uttar Pradesh", type: "Public", ranking: 5, accreditation: "NAAC A Grade", description: "Established in 1916 by Pt. Madan Mohan Malaviya, BHU is one of the largest residential universities in Asia, covering medicine, law, engineering, and arts.", avgPlacement: "₹5 LPA - ₹12 LPA", highestPlacement: "₹32 LPA", officialWebsite: "www.bhu.ac.in", cutoffs: "CUET scores vary by course (usually 85-95 percentile).", admissionProcess: "Admission through CUET counselling process.", reviews: "Huge, green, peaceful campus. Highly historical significance. Affordable hostels and rich culture." },
    { id: "jnu-delhi", name: "Jawaharlal Nehru University", location: "New Delhi", type: "Public", ranking: 2, accreditation: "NAAC A++ Grade", description: "Renowned for its excellence in social sciences, humanities, languages, and international studies. It is famous for its vibrant debate culture.", avgPlacement: "₹5 LPA - ₹10 LPA", highestPlacement: "₹24 LPA", officialWebsite: "www.jnu.ac.in", cutoffs: "CUET-PG / CUET-UG score requirements are high (90+ percentile).", admissionProcess: "CUET-based score rankings followed by counselling registration.", reviews: "Highly intellectual discussions. Democratic campus. Subsidised mess food. Amazing library assets." },
    { id: "vit-vellore", name: "Vellore Institute of Technology", location: "Vellore, Tamil Nadu", type: "Private", ranking: 11, accreditation: "NAAC A++ Grade", description: "A major private engineering institute in South India, known for modern labs, foreign exchanges, and massive placement drives.", avgPlacement: "₹8.5 LPA", highestPlacement: "₹1.02 Crore PA", officialWebsite: "www.vit.ac.in", cutoffs: "VITEEE rank under 1000 for CSE Category 1. Under 20,000 for Category 5.", admissionProcess: "Appear for VITEEE computer exam -> Participate in VIT Counselling.", reviews: "Excellent infrastructure. Strict rules. Hundreds of companies visit for placements, providing massive opportunities." },
    { id: "srm-chennai", name: "SRM Institute of Science and Technology", location: "Kattankulathur, Chennai, Tamil Nadu", type: "Private", ranking: 30, accreditation: "NAAC A++ Grade", description: "SRM is a popular private university offering diverse courses in engineering, medicine, and management with a massive student intake.", avgPlacement: "₹6.8 LPA", highestPlacement: "₹45 LPA", officialWebsite: "www.srmist.edu.in", cutoffs: "SRMJEEE rank criteria.", admissionProcess: "Appear for SRMJEEE and attend counseling slots.", reviews: "Very large campus. Excellent coding clubs. High opportunities for mediocre students to get placement." },
    { id: "bits-pilani", name: "BITS Pilani", location: "Pilani, Rajasthan (also Goa & Hyderabad campuses)", type: "Private", ranking: 20, accreditation: "NAAC A Grade", description: "One of the most prestigious private engineering universities in India. Known for its 'No Attendance Policy' and high-standard alumni startup networks.", avgPlacement: "₹17.0 LPA", highestPlacement: "₹1.33 Crore PA", officialWebsite: "www.bits-pilani.ac.in", cutoffs: "BITSAT score of 320+ for CSE Pilani campus.", admissionProcess: "Clear BITSAT online entrance examination.", reviews: "Zero attendance policy offers amazing freedom to build products. Excellent startup support. Premium crowd." },
    { id: "manipal-academy", name: "Manipal Academy of Higher Education", location: "Manipal, Karnataka", type: "Private", ranking: 16, accreditation: "NAAC A++ Grade", description: "A prestigious private university town in Karnataka, known for excellent clinical medical and engineering facilities and vibrant campus town environment.", avgPlacement: "₹8.0 LPA", highestPlacement: "₹43 LPA", officialWebsite: "www.manipal.edu", cutoffs: "MET (Manipal Entrance Test) score requirements.", admissionProcess: "Admission through MET ranks.", reviews: "Beautiful coastal town setting. Extremely modern campus design. Student life is outstanding." },
    { id: "kiit-bhubaneswar", name: "Kalinga Institute of Industrial Technology", location: "Bhubaneswar, Odisha", type: "Private", ranking: 29, accreditation: "NAAC A++ Grade", description: "An extensive campus offering engineering, medical, law, and management fields with record placements every year.", avgPlacement: "₹6.5 LPA", highestPlacement: "₹38 LPA", officialWebsite: "www.kiit.ac.in", cutoffs: "KIITEE rank-based counseling.", admissionProcess: "Apply for KIITEE (which has no application fee).", reviews: "Excellent sports complexes. Food is good. Placement department is very active." },
    { id: "amity-noida", name: "Amity University, Noida", location: "Noida, Uttar Pradesh", type: "Private", ranking: 35, accreditation: "NAAC A+ Grade", description: "Known for its massive high-tech infrastructure, global campuses, and extensive corporate connections.", avgPlacement: "₹5.5 LPA", highestPlacement: "₹30 LPA", officialWebsite: "www.amity.edu", cutoffs: "12th board marks above 80% for direct entry, or AMCAT entrance.", admissionProcess: "Based on 12th board marks + video interview process.", reviews: "Luxury infrastructure, nice cafeterias, strict 75% attendance rule, decent corporate placements." },
    { id: "lpu-phagwara", name: "Lovely Professional University", location: "Phagwara, Punjab", type: "Private", ranking: 38, accreditation: "NAAC A++ Grade", description: "India's largest single-campus private university, hosting thousands of students from multiple states and countries.", avgPlacement: "₹5.8 LPA", highestPlacement: "₹64 LPA", officialWebsite: "www.lpu.in", cutoffs: "LPUNEST entrance exam.", admissionProcess: "Appear for LPUNEST and participate in online admission allocation.", reviews: "Huge campus with mall, hospital, and high-security structures. Diverse culture. Decent placements." },
    { id: "chandigarh-university", name: "Chandigarh University", location: "Gharuan, Mohali, Punjab", type: "Private", ranking: 27, accreditation: "NAAC A+ Grade", description: "A highly popular private university in Punjab, providing diverse technical and non-technical fields with massive placement volumes.", avgPlacement: "₹7.2 LPA", highestPlacement: "₹54.7 LPA", officialWebsite: "www.cuchd.in", cutoffs: "CUCET entrance exam scores.", admissionProcess: "Appear for CUCET exam and apply through university score counseling.", reviews: "Excellent hostels. High-tech labs. Coding culture is solid, with a dedicated placement cell." }
  ];

  for (const col of collegesData) {
    const upsertedCollege = await prisma.college.upsert({
      where: { id: col.id },
      update: col,
      create: col,
    });

    // Seed courses only if the college was just created (no courses yet)
    const existingCourses = await prisma.course.count({ where: { collegeId: upsertedCollege.id } });
    if (existingCourses === 0) {
      await prisma.course.createMany({
        data: [
          { collegeId: upsertedCollege.id, name: "Bachelor of Technology (B.Tech) - Computer Science", duration: "4 Years", fees: upsertedCollege.type === "Public" ? "₹2,00,000 per year" : "₹4,50,000 per year", seats: 120 },
          { collegeId: upsertedCollege.id, name: "Bachelor of Technology (B.Tech) - Electronics", duration: "4 Years", fees: upsertedCollege.type === "Public" ? "₹2,00,000 per year" : "₹4,20,000 per year", seats: 90 },
          { collegeId: upsertedCollege.id, name: "Master of Business Administration (MBA)", duration: "2 Years", fees: upsertedCollege.type === "Public" ? "₹8,00,000 complete" : "₹12,00,000 complete", seats: 60 }
        ]
      });
    }
  }
  ...
  // ─────────────────────────────────────────────
  // 4. Seed Mentors (upsert on email — safe to re-run)
  // ─────────────────────────────────────────────
  console.log("Seeding Mentors...");
  const mentorsData = [
    { name: "Ananya Sharma", email: "ananya.sharma@example.com", password: "Password@123", expertise: "Software Engineering, Frontend Systems, Web Architecture", experienceYears: 8, rating: 4.9, totalSessions: 142, hourlyRateCoins: 120, education: "B.Tech in Computer Science, NIT Trichy", skills: "React, Next.js, System Design, Javascript", guidanceAreas: "Software Engineering, Web Development, Resume Review", availability: "Mon, Wed, Fri (4:00 PM - 7:00 PM)", bio: "Ex-SDE at Google. Passionate about mentoring students in DSA, building robust web systems, and crafting job application strategies.", photo: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150" },
    { name: "Rajesh Iyer", email: "rajesh.iyer@example.com", password: "Password@123", expertise: "AI/ML, Natural Language Processing, MLOps", experienceYears: 6, rating: 4.8, totalSessions: 98, hourlyRateCoins: 150, education: "MS in Machine Learning, IIIT Hyderabad", skills: "Python, PyTorch, TensorFlow, LLMs", guidanceAreas: "AI/ML, Data Science, Academic Research", availability: "Tue, Thu (6:00 PM - 9:00 PM)", bio: "Research Scientist working on generative models. Helping students shift into AI research and model deployment careers.", photo: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=150" },
    { name: "Dr. Sandeep Patel", email: "sandeep.patel@example.com", password: "Password@123", expertise: "Data Science, Business Intelligence, Data Engineering", experienceYears: 7, rating: 4.7, totalSessions: 110, hourlyRateCoins: 130, education: "M.Sc. in Statistics, Delhi University", skills: "Python, SQL, Tableau, Pandas", guidanceAreas: "Data Science, Analytics roles, SQL practice", availability: "Sat (10:00 AM - 2:00 PM)", bio: "Senior Data Scientist at a major analytics firm. Expert in statistical modeling, SQL query tuning, and business visualization dashboards.", photo: "https://images.unsplash.com/photo-1607746882042-944635dfe10e?w=150" },
    { name: "Vikram Malhotra", email: "vikram.malhotra@example.com", password: "Password@123", expertise: "UPSC CSE preparation, Ethics, Essay Writing", experienceYears: 10, rating: 4.9, totalSessions: 320, hourlyRateCoins: 200, education: "MA in Public Administration, BHU", skills: "Polity, History, Answer Writing, Optional Strategy", guidanceAreas: "UPSC, Civil Services preparation, Interview tips", availability: "Sunday (11:00 AM - 5:00 PM)", bio: "Former civil services applicant who reached Mains/Interview multiple times. Mentored hundreds of current IAS/IPS officers in General Studies and writing tips.", photo: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150" },
    { name: "Nisha Goel", email: "nisha.goel@example.com", password: "Password@123", expertise: "SSC CGL / Govt Exams Prep, quantitative shortcuts", experienceYears: 5, rating: 4.6, totalSessions: 215, hourlyRateCoins: 100, education: "B.Sc Mathematics, Banaras Hindu University", skills: "Fast Math, Logical Reasoning, General Awareness", guidanceAreas: "SSC CGL, Banking Exams, Railway Exams", availability: "Mon, Tue (5:00 PM - 8:00 PM)", bio: "Cleared SSC CGL with top rank. Helping aspirants crack government jobs using smart calculation shortcuts and structured GK templates.", photo: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150" },
    { name: "Siddharth Sen", email: "siddharth.sen@example.com", password: "Password@123", expertise: "Banking Exams, IBPS, Financial Awareness", experienceYears: 9, rating: 4.8, totalSessions: 180, hourlyRateCoins: 110, education: "B.Com, Delhi University", skills: "Banking Terms, Data Interpretation, Logical Puzzles", guidanceAreas: "Banking, Finance positions, Clerical training", availability: "Wed, Thu (7:00 PM - 9:00 PM)", bio: "Manager at a public sector bank. Dedicated to teaching candidates the core concepts of banking awareness and cracking bank PO/Clerk tests.", photo: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150" },
    { name: "Karan Johar", email: "karan.johar@example.com", password: "Password@123", expertise: "Medical Entrance (NEET), Biology concepts", experienceYears: 12, rating: 4.9, totalSessions: 420, hourlyRateCoins: 180, education: "MD in Pediatrics, AIIMS Delhi", skills: "Anatomy, Physiology, Chemistry tips, MCQ strategy", guidanceAreas: "NEET UG, MBBS advice, MD pathways", availability: "Saturday (4:00 PM - 8:00 PM)", bio: "Practicing Pediatrician and biology mentor. Helping medical aspirants digest complex physiology topics and structure mock test routines.", photo: "https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=150" },
    { name: "Meera Nair", email: "meera.nair@example.com", password: "Password@123", expertise: "Corporate Law, Litigations, Contract drafting", experienceYears: 8, rating: 4.7, totalSessions: 85, hourlyRateCoins: 140, education: "BA LLB (Hons), NLSIU Bangalore", skills: "Corporate compliance, Contract law, IP filing", guidanceAreas: "Law, CLAT preparation, Firm placements", availability: "Friday (5:00 PM - 8:00 PM)", bio: "Associate Partner at a law firm. Guiding law students on choosing corporate vs litigation, finding internships, and preparing for CLAT.", photo: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150" },
    { name: "Pankaj Tripathi", email: "pankaj.tripathi@example.com", password: "Password@123", expertise: "MBA Prep, CAT Strategy, Business Communication", experienceYears: 6, rating: 4.8, totalSessions: 165, hourlyRateCoins: 160, education: "MBA, IIM Ahmedabad", skills: "DILR, VARC, Interview grooming, Group discussions", guidanceAreas: "MBA admissions, CAT prep, Consulting careers", availability: "Sunday (10:00 AM - 1:00 PM)", bio: "Senior Strategy Manager. Specializes in guiding MBA aspirants through DILR tricks, resume building, and crushing B-school interviews.", photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150" },
    { name: "Amit Verma", email: "amit.verma@example.com", password: "Password@123", expertise: "UI/UX, Product Design, Portfolio drafting", experienceYears: 7, rating: 4.9, totalSessions: 130, hourlyRateCoins: 130, education: "B.Des, National Institute of Design (NID)", skills: "Figma, Wireframing, Visual Design, Typography", guidanceAreas: "Design careers, Portfolio Review, UCEED prep", availability: "Mon, Fri (6:00 PM - 8:00 PM)", bio: "Lead UI/UX Designer. Focused on helping students structure design portfolios, understand user-centric models, and break into design firms.", photo: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150" }
  ];
  ...
  for (const mentor of mentorsData) {
    ...
    await prisma.mentorProfile.upsert({
      ...
      update: {
        ...
        hourlyRateCoins: mentor.hourlyRateCoins,
  ...
  // ─────────────────────────────────────────────
  // 5. Seed Default Student (upsert — safe to re-run)
  // ─────────────────────────────────────────────
  ...
  await prisma.studentProfile.upsert({
    where: { userId: defaultStudent.id },
    update: {},
    create: {
  ...
  // Seed Study Plan only if none exists for this student
  const existingPlan = await prisma.studyPlan.findFirst({ where: { userId: defaultStudent.id } });
  if (!existingPlan) {
  ...
  // Seed Habits only if none exist
  const existingHabits = await prisma.habit.count({ where: { userId: defaultStudent.id } });
  if (existingHabits === 0) {
  ...
  // Seed Goals only if none exist
  const existingGoals = await prisma.goal.count({ where: { userId: defaultStudent.id } });
  if (existingGoals === 0) {
  ...
  // Seed Mock Test + Attempts only if none exist
  const existingMocks = await prisma.mockTest.count({ where: { examId: "jee-advanced" } });
  if (existingMocks === 0) {
